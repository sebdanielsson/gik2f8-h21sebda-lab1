const RenderDetailsHTML = (item) => {
    let detailsHTML = `
        <div id="book_details" class="book-details min-w-fit hidden flex-row p-4 gap-4 rounded-lg absolute dark:bg-[#3B2A83] bg-indigo-500 dark:text-indigo-300 text-white">
